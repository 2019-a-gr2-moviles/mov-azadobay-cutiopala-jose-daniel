...
//            }
    ...
    override fun onBindViewHolder(myViewHolder: AdaptadorListaSolicitud.MyViewHolder, position: Int) {
        ...
        myViewHolder.nombreTextView.text = compra.idLector!!.nombre
        myViewHolder.apellidoTextView.text = compra.idLector!!.apellido
        myViewHolder.cedulaTextView.text = compra.idLector!!.cedula
        myViewHolder.fechaTextView.text = compra.fecha
        myViewHolder.zapatoTextView.text = "${compra.idLibro!!.titulo}"
